...
const { source, schemas, objects, selected, selectedId, schemaId, scanning, scanResult, scanError, states, busy, editingDisabled, saving, saveError, success, dirty, dirtyIds, updateSelected, save, load, select, selectSchema, scan, mockMode, confirmOpen, finishConfirmation, hasPermission } = useDataCollection(scenario)
